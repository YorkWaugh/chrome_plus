    ...
    if (buffer) {
      ...
      TraversalGZIPFile((BYTE*)buffer, [=](uint8_t* begin, uint32_t size,
        ...
        if (pos) {
          ...
          const char prouct_title[] = u8R"({aboutBrowserVersion}</div><div class="secondary"><a target="_blank" href="https://github.com/Bush2021/chrome_plus">Chrome++</a> )" "alpha-37ede4d" u8R"( modified version</div>)";
